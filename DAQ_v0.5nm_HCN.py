...
#%%
filepath = r"C:\Users\H\Documents\Lab_BUPT\Data\DAQ_data\MZI\DAQ0.5.csv"
...
plt.plot(data_cut.index, data_cut.trans, c='b', lw=1, alpha=0.7, label='trans')
...
data_cut['mzi_min'], data_cut['mzi_max'] = pmlt.envPeak(data_cut.MZI.values, delta=0.5, sg_order=0)
...
plt.xlim(data_cut.index[int(2e3)], data_cut.index[int(5e3)])
...
# data_save.to_csv('D:/wh/Documents/py_works/Cavity_disper/data_daq0.5.csv', encoding='utf-8')
#%%